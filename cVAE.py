...
## by Jiawei (Eric) He
## Version 2: conditional VAE
## The condition is on label. Theoratically, it will learn a better representaton, since the input is now combined with the one-hot label vector.
